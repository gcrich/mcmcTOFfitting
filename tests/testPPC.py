...
dStats = np.percentile(dSpectrumCollection[1:,:], [16,50,84], axis=0)
...
dZeroStats= np.percentile(dZeroSamples, [16,50,84], axis=0)
...
axNeutrons.set_ylabel('Counts (a.u.)')
...
dBand = axDeuterons.fill_between(ppcTool.eD_binCenters, dStats[0,:], dStats[2,:],
                         ...
                         label='Deuteron energies after transport')
...
dZBand = axDZero.fill_between(ppcTool.eD_binCenters, dZeroStats[0,:], 
